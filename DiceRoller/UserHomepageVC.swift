...
class UserHomepageVC: UIViewController, WCSessionDelegate, UITableViewDataSource, UITableViewDelegate
{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        cell.qtyLabel.text = " Quantity: " + String(PhoneCore.theRowData[indexPath.row].objectForKey("total")!)
        cell.detailLabel.text = "Roll Details: " + String(PhoneCore.theRowData[indexPath.row].objectForKey("Details")!)
